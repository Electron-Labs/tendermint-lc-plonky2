...
pub async fn get_inputs_for_height(
    ...
    let mt_untrusted = get_block_header_merkle_tree(untrusted_block.clone().header.clone());
    let mt_trusted = get_block_header_merkle_tree(trusted_block.clone().header.clone());
